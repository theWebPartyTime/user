<template>
  <nav class="nav-panel">
    ...
    <div class="profile">
      <img
        src="@/assets/update_icon.svg"
        alt=""
        @click="userInfo.generateUsername()"
      ...
      <SecondaryButton class="profile-module" :class="{ visible: openedModule }"
        >Выйти</SecondaryButton
      >
    </div>
  </nav>
</template>
...
export default defineComponent({
  ...
  mounted() {
    ...
    this.userInfo = store;
    this.timerCounter = setInterval(this.countdown, 1000)
  },

  unmounted() {
    clearInterval(this.timerCounter as number)
  }
});
</script>
